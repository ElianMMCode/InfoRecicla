...
public record VentaInventarioResponseDTO(
    ...
    public static VentaInventarioResponseDTO derivado(VentaInventario venta) {
        return new VentaInventarioResponseDTO(
                ...
                venta.getInventario().getMaterial().getCtgMaterial() != null ? venta.getInventario().getMaterial().getCtgMaterial().getNombre() : "",
                venta.getInventario().getMaterial().getTipoMaterial() != null ? venta.getInventario().getMaterial().getTipoMaterial().getNombre() : "",
                venta.getFechaVenta(),
