...
-- 5. Tabla ciudades
CREATE TABLE
  ciudades (id INT PRIMARY KEY, nombre VARCHAR(100) NOT NULL);
...
ALTER TABLE perfiles_ciudadano ADD CONSTRAINT fk_perfiles_ciudadano_usuario_id FOREIGN KEY (usuario_id) REFERENCES usuarios (id);

ALTER TABLE perfiles_punto_eca ADD CONSTRAINT fk_perfiles_punto_eca_usuario_id FOREIGN KEY (usuario_id) REFERENCES usuarios (id),
ADD CONSTRAINT fk_perfiles_punto_eca_punto_eca_id FOREIGN KEY (punto_eca_id) REFERENCES puntos_eca (id);

ALTER TABLE localidades ADD CONSTRAINT fk_localidades_ciudad_id FOREIGN KEY (ciudad_id) REFERENCES ciudades (id);

ALTER TABLE puntos_eca ADD CONSTRAINT fk_puntos_eca_gestor_id FOREIGN KEY (gestor_id) REFERENCES usuarios (id),
...
ALTER TABLE capacidad_material_punto_eca ADD CONSTRAINT fk_capacidad_material_punto_eca_punto_eca_id FOREIGN KEY (punto_eca_id) REFERENCES puntos_eca (id),
...
ALTER TABLE inventario ADD CONSTRAINT fk_inventario_punto_eca_id FOREIGN KEY (punto_eca_id) REFERENCES puntos_eca (id),
ADD CONSTRAINT fk_inventario_material_id FOREIGN KEY (material_id) REFERENCES materiales (id);

ALTER TABLE publicaciones ADD CONSTRAINT fk_publicaciones_autor_id FOREIGN KEY (autor_id) REFERENCES usuarios (id),
ADD CONSTRAINT fk_publicaciones_tipo_id FOREIGN KEY (tipo_id) REFERENCES tipos_publicacion (id);

ALTER TABLE favoritos ADD CONSTRAINT fk_favoritos_usuario_id FOREIGN KEY (usuario_id) REFERENCES usuarios (id),
ADD CONSTRAINT fk_favoritos_publicacion_id FOREIGN KEY (publicacion_id) REFERENCES publicaciones (id);

ALTER TABLE comentarios ADD CONSTRAINT fk_comentarios_usuario_id FOREIGN KEY (usuario_id) REFERENCES usuarios (id),
...
ALTER TABLE notificaciones ADD CONSTRAINT fk_notificaciones_usuario_id FOREIGN KEY (usuario_id) REFERENCES usuarios (id),
ADD CONSTRAINT fk_notificaciones_tipo_id FOREIGN KEY (tipo_id) REFERENCES tipos_notificacion (id);

ALTER TABLE conversaciones ADD CONSTRAINT fk_conversaciones_usuario_eca_id FOREIGN KEY (usuario_eca_id) REFERENCES usuarios (id),
ADD CONSTRAINT fk_conversaciones_usuario_ciudadano_id FOREIGN KEY (usuario_ciudadano_id) REFERENCES usuarios (id);

ALTER TABLE mensajes ADD CONSTRAINT fk_mensajes_conversacion_id FOREIGN KEY (conversacion_id) REFERENCES conversaciones (id),
ADD CONSTRAINT fk_mensajes_remitente_id FOREIGN KEY (remitente_id) REFERENCES usuarios (id);

ALTER TABLE programacion_recoleccion ADD CONSTRAINT fk_programacion_recoleccion_punto_eca_id FOREIGN KEY (punto_eca_id) REFERENCES puntos_eca (id),
...
ALTER TABLE materiales_plantas_reciclaje ADD CONSTRAINT fk_materiales_plantas_reciclaje_planta_id FOREIGN KEY (planta_id) REFERENCES plantas_reciclaje (id),
ADD CONSTRAINT fk_materiales_plantas_reciclaje_material_id FOREIGN KEY (material_id) REFERENCES materiales (id);

ALTER TABLE categorias_publicaciones ADD CONSTRAINT fk_categorias_publicaciones_publicacion_id FOREIGN KEY (publicacion_id) REFERENCES publicaciones (id);

ALTER TABLE votos ADD CONSTRAINT fk_votos_usurios_id FOREIGN KEY (usuarios_id) REFERENCES usuarios (id);

ALTER TABLE comentarios ADD CONSTRAINT fk_comentarios_usurios_id FOREIGN KEY (usuarios_id) REFERENCES usuarios (id);

ALTER TABLE compras ADD CONSTRAINT fk_comentarios_inventario_id FOREIGN KEY (inventario_id) REFERENCES inventario (id);

ALTER TABLE entradas ADD CONSTRAINT fk_entradas_inventario_id FOREIGN KEY (inventario_id) REFERENCES inventario (id);

ALTER TABLE salidas ADD CONSTRAINT fk_salidas_inventario_id FOREIGN KEY (inventario_id) REFERENCES inventario (id);

ADD CONSTRAINT fk_salidas_centro_de_acopio_id FOREIGN KEY (centros_de_acopio_id) REFERENCES centros_de_acopio (id);

ALTER TABLE despachos ADD CONSTRAINT fk_despacho_inventario_id FOREIGN KEY (inventario_id) REFERENCES inventario (id);

ALTER TABLE centros_de_acopio ADD CONSTRAINT fk_centro_de_acopio_punto_eca_id FOREIGN KEY (eca_id) REFERENCES puntos_eca (id);