                        ...
                        <div class="card-body">
                            <form id="formMaterial" name="formMaterial" class="row g-3" method="POST" action="{{ route('materiales.store') }}">
                                ...
                                <div class="col-md-6"><label for="tipo_id"
                                        class="form-label text-success">Tipo</label><select class="form-select" name="tipo" form="form-filtros">
                                        <option value="">Todos</option>
                                        @foreach ($tipos as $t)
                                ...
                                <div class="col-md-6"><label for="categoria_id"
                                        class="form-label text-success">Categoría</label><select class="form-select" name="categoria" form="form-filtros">
                                        <option value="">Todas</option>
                                        @foreach ($categorias as $c)
