    ...
    <div class="container-fluid">
        <div class="row min-vh-100">
                    ...
                    <div class="card border-success h-100">
                        ...
                        <div class="card-body">
                            <div class="row g-2">
                                ...
                                <div class="col-6 col-md-4"><a href="#ecas-crear" class="btn btn-success w-100">Nuevo
                                        ECA</a></div>
                ...
                <div id="usuarios-listado" class="mb-3">
                                ...
                                <div class="col-6 col-md-3">
                                    ...
                                    <select class="form-select" name="rol">
                                        ...
                                        <option value="Administrador"
                                            @if (request('rol') == 'Administrador') selected @endif>Administrador</option>
                                        <option value="GestorECA" @if (request('rol') == 'GestorECA') selected @endif>
                                            GestorECA</option>
                                        <option value="Ciudadano" @if (request('rol') == 'Ciudadano') selected @endif>
                                            Ciudadano</option>
                                    </select>
                                </div>
                                <div class="col-6 col-md-3">
                                    ...
                                    <select class="form-select" name="estado">
                                        <option value="">Todos</option>
                                        <option value="activo" @if (request('estado') == 'activo') selected @endif>activo
                                        </option>
                                        <option value="inactivo" @if (request('estado') == 'inactivo') selected @endif>
                                            inactivo</option>
                                        <option value="bloqueado" @if (request('estado') == 'bloqueado') selected @endif>
                                            bloqueado</option>
                                    </select>
                                </div>
                    ...
                    <div class="card border-success">
                            ...
                            <table class="table table-hover align-middle m-0">
                                ...
                                <tbody>
                                    @foreach ($usuariosList as $usuario)
                                        <tr>
                                            <form method="POST"
                                                action="{{ url('admin/usuario/edit/' . $usuario->id) }}">
                                                @csrf
                                                ...
                                                <td>
                                                    <select name="rol" class="form-select form-select-sm"
                                                        required>
                                                        <option value="Administrador"
                                                            @if ($usuario->rol == 'Administrador') selected @endif>
                                                            Administrador</option>
                                                        <option value="GestorECA"
                                                            @if ($usuario->rol == 'GestorECA') selected @endif>
                                                            GestorECA</option>
                                                        <option value="Ciudadano"
                                                            @if ($usuario->rol == 'Ciudadano') selected @endif>
                                                            Ciudadano</option>
                                                    </select>
                                                </td>
                                                <td>
                                                    <select name="estado" class="form-select form-select-sm">
                                                        <option value="activo"
                                                            @if ($usuario->estado == 'activo') selected @endif>activo
                                                        </option>
                                                        <option value="inactivo"
                                                            @if ($usuario->estado == 'inactivo') selected @endif>inactivo
                                                        </option>
                                                        <option value="bloqueado"
                                                            @if ($usuario->estado == 'bloqueado') selected @endif>
                                                            bloqueado</option>
                                                    </select>
                                                </td>
                                                <td class="text-end">
                        ...
                        <div class="card-footer d-flex justify-content-between align-items-center">
                            <span class="small text-success">Mostrando {{ $usuariosList->count() }} de
                                {{ $usuariosList->total() }}</span>
                            <div>
                    ...
                    <div class="card border-success">
                        <div class="card-body">
                            <form id="formUsuario" name="formUsuario" class="row g-3"
                                ...
                                <div class="col-md-6"><label for="avatar_url" class="form-label text-success">Avatar
                                        URL</label><input id="avatar_url" name="avatar_url" type="url"
                                        class="form-control"></div>
                            ...
                            <form method="GET" action="#mod-ecas" class="row g-2">
                                ...
                                <div class="col-6 col-md-3">
                                    ...
                                    <select class="form-select" name="estado_eca">
                                        <option value="">Todos</option>
                                        <option value="activo" @if (request('estado_eca') == 'activo') selected @endif>
                                            activo</option>
                                        <option value="inactivo" @if (request('estado_eca') == 'inactivo') selected @endif>
                                            inactivo</option>
                                        <option value="bloqueado" @if (request('estado_eca') == 'bloqueado') selected @endif>
                                            bloqueado</option>
                                    </select>
                                </div>
                                <div class="col-6 col-md-3">
                            ...
                            <form method="POST" action="{{ route('admin.eca.update') }}">
                                ...
                                <table class="table table-hover m-0">
                                    ...
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select name="estado[{{ $punto->id }}]"
                                                        ...
                                                        <option value="activo"
                                                            @if ($punto->estado == 'activo') selected @endif>activo
                                                        </option>
                                                        <option value="inactivo"
                                                            @if ($punto->estado == 'inactivo') selected @endif>inactivo
                                                        </option>
                                                        <option value="bloqueado"
                                                            @if ($punto->estado == 'bloqueado') selected @endif>
                                                            bloqueado</option>
                                                    </select>
                                                </td>
                                                <td class="text-end">
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="5" class="text-center">No hay puntos ECA registrados.
                                                </td>
                                            </tr>
                                        @endforelse
                                    </tbody>
            ...
            <section id="mod-materiales" class="mb-5">
                ...
                <ul class="nav nav-pills mb-3">
                    <li class="nav-item"><a href="#materiales-resumen" class="nav-link active bg-success">Resumen</a>
                    </li>
                        ...
                        <form class="row g-2" method="GET" action="{{ url('admin') }}">
                            ...
                            <div class="col-6 col-md-3">
                                ...
                                <select class="form-select" name="categoria_material">
                                    ...
                                    @foreach ($categorias as $c)
                                        <option value="{{ $c->id }}"
                                            @if (request('categoria_material') == $c->id) selected @endif>{{ $c->nombre }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-6 col-md-3">
                                ...
                                <select class="form-select" name="tipo_material">
                                    ...
                                    @foreach ($tipos as $t)
                                        <option value="{{ $t->id }}"
                                            @if (request('tipo_material') == $t->id) selected @endif>{{ $t->nombre }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <table class="table table-hover m-0">
                            ...
                            <tbody>
                                @foreach ($materiales as $material)
                                    <tr>
                                        <form method="POST"
                                            action="{{ url('materiales/update/' . $material->id) }}">
                                            @csrf
                                            ...
                                            <td>
                                                <select name="categoria_id" class="form-select form-select-sm">
                                                    @foreach ($categorias as $c)
                                                        <option value="{{ $c->id }}"
                                                            @if ($material->categoria_id == $c->id) selected @endif>
                                                            {{ $c->nombre }}</option>
                                                    @endforeach
                                                </select>
                                            </td>
                                            <td>
                                                <select name="tipo_id" class="form-select form-select-sm">
                                                    @foreach ($tipos as $t)
                                                        <option value="{{ $t->id }}"
                                                            @if ($material->tipo_id == $t->id) selected @endif>
                                                            {{ $t->nombre }}</option>
                                                    @endforeach
                                                </select>
                                            </td>
                                            <td><input type="url" name="imagen_url"
                                                    value="{{ $material->imagen_url }}"
                                                    class="form-control form-control-sm"></td>
                                            <td class="text-end">
                ...
                <div id="tipos" class="card border-success mb-3">
                    ...
                    <div class="card-body">
                        <form class="row g-2 mb-3" method="GET" action="{{ url('admin') }}">
                            <div class="col-md-10">
                                <input type="text" name="buscar_tipo" class="form-control"
                                    value="{{ request('buscar_tipo') }}" placeholder="Buscar tipo por nombre...">
                            </div>
                        ...
                        <form class="row g-2 mb-3" method="POST" action="{{ url('tipos/store') }}">
                            ...
                            <div class="col-md-5">
                                <input type="text" name="nombre" class="form-control"
                                    placeholder="Nombre del tipo" required>
                            </div>
                            <div class="col-md-5">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover m-0">
                                ...
                                <tbody>
                                    @foreach ($tipos as $tipo)
                                        <tr>
                                            <form method="POST" action="{{ url('tipos/update/' . $tipo->id) }}"
                                                class="d-flex">
                                                @csrf
                                                <td><input type="text" name="nombre"
                                                        value="{{ $tipo->nombre }}"
                                                ...
                                                <td class="text-end">
                                                    <button type="submit"
                                                        class="btn btn-sm btn-success">Guardar</button>
                                                    <form method="POST"
                                                        action="{{ url('tipos/delete/' . $tipo->id) }}"
                            ...
                            <div class="card-footer d-flex justify-content-between align-items-center">
                                <span class="small text-success">Mostrando {{ $tipos->count() }} de
                                    {{ $tipos->total() }}</span>
                                <div>
                ...
                <div id="categorias-material" class="card border-success mb-3">
                    ...
                    <div class="card-body">
                        <form class="row g-2 mb-3" method="GET" action="{{ url('admin') }}">
                            <div class="col-md-10">
                                <input type="text" name="buscar_categoria" class="form-control"
                                    value="{{ request('buscar_categoria') }}"
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover m-0">
                                ...
                                <tbody>
                                    @foreach ($categorias as $categoria)
                                        <tr>
                                            <form method="POST"
                                                action="{{ url('categorias/update/' . $categoria->id) }}"
                                                class="d-flex">
                                                @csrf
                                                <td><input type="text" name="nombre"
                                                ...
                                                <td class="text-end">
                                                    <button type="submit"
                                                        class="btn btn-sm btn-success">Guardar</button>
                                                    <form method="POST"
                                                        action="{{ url('categorias/delete/' . $categoria->id) }}"
                                                        style="display:inline-block;">
                                                        @csrf
                                                        <button type="submit"
                                                            class="btn btn-sm btn-outline-danger">Eliminar</button>
                            ...
                            <div class="card-footer d-flex justify-content-between align-items-center">
                                <span class="small text-success">Mostrando {{ $categorias->count() }} de
