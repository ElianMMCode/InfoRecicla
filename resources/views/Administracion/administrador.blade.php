      ...
      <main class="col-12 col-lg-9 col-xl-10 p-3 p-lg-4">
        ...
        <section id="mod-usuarios" class="mb-5">
                ...
                <table class="table table-hover align-middle m-0">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="text-end"><a class="btn btn-sm btn-outline-success" href="#usuarios-crear">Editar</a> <a class="btn btn-sm btn-outline-danger" href="#">Eliminar</a></td>
                    </tr>
                  </tbody>
                </table>
              </div>
              <div class="card-footer d-flex justify-content-between align-items-center"><span class="small text-success">Mostrando 0 de 0</span>
          ...
          <div id="usuarios-crear">
            <div class="card border-success">
              <div class="card-body">
                <form id="formUsuario" name="formUsuario" class="row g-3" action="{{ route('admin.usuarios.create') }}" method="POST">
                  ...
                  <div class="col-md-4"><label for="rol" class="form-label text-success">Rol</label><select id="rol" name="rol" class="form-select" required>
                      <option value="Administrador">Administrador</option>
                      <option value="GestorECA">GestorECA</option>
                      <option value="Ciudadano">Ciudadano</option>
                    </select></div>
                  <div class="col-md-4"><label for="estado" class="form-label text-success">Estado</label><select id="estado" name="estado" class="form-select">
                      <option value="activo">activo</option>
                      <option value="inactivo">inactivo</option>
                      <option value="bloqueado">bloqueado</option>
                    </select></div>
                  <div class="col-md-4"><label for="genero" class="form-label text-success">Género</label><select id="genero" name="genero" class="form-select">
                      <option value="Masculino">Masculino</option>
                      <option value="Femenino">Femenino</option>
                      <option value="Otro">Otro</option>
                    </select></div>
                  <div class="col-md-6"><label for="tipo_documento" class="form-label text-success">Tipo Documento</label><select id="tipo_documento" name="tipo_documento" class="form-select">
        ...
        <section id="mod-ecas" class="mb-5">
            ...
            <div class="card border-success mb-2">
              <div class="card-body">
                <form class="row g-2">
                  ...
                  <div class="col-6 col-md-3"><label class="form-label text-success">Estado</label><select class="form-select">
                      <option value="">Todos</option>
                      <option>activo</option>
                      <option>inactivo</option>
                      <option>bloqueado</option>
                    </select></div>
                  <div class="col-6 col-md-3"><label class="form-label text-success">Gestor</label><select class="form-select">
                ...
                <table class="table table-hover m-0">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>—</td>
                      <td><span class="badge text-bg-success">—</span></td>
                      <td class="text-end"><a class="btn btn-sm btn-outline-success" href="#ecas-crear">Editar</a> <a class="btn btn-sm btn-outline-danger" href="#">Eliminar</a></td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div class="card border-success">
              <div class="card-body">
                <form id="formEca" name="formEca" class="row g-3">
                  ...
                  <div class="col-md-6"><label for="estado" class="form-label text-success">Estado</label><select id="estado" name="estado" class="form-select">
                      <option value="activo">activo</option>
                      <option value="inactivo">inactivo</option>
                      <option value="bloqueado">bloqueado</option>
                    </select></div>
          ...
          <div id="programaciones">
            <div class="card border-success">
              <div class="card-header bg-success-subtle border-success"><span class="fw-semibold text-success">Programaciones de recolección</span></div>
              <div class="card-body">
                <form id="formProgramacion" name="formProgramacion" class="row g-3">
                  ...
                  <div class="col-md-4"><label for="frecuencia" class="form-label text-success">Frecuencia</label><select id="frecuencia" name="frecuencia" class="form-select">
        ...
        <section id="mod-materiales" class="mb-5">
          ...
          <div id="materiales-listado" class="card border-success mb-3">
            <div class="card-body">
              <form class="row g-2">
                ...
                <div class="col-6 col-md-3"><label class="form-label text-success">Categoría</label><select class="form-select">
                    <option value="">Todas</option>
                  </select></div>
                <div class="col-6 col-md-3"><label class="form-label text-success">Tipo</label><select class="form-select">
                    <option value="">Todos</option>
                  </select></div>
                <div class="col-12 col-md-auto d-flex align-items-end"><a class="btn btn-outline-success" href="#">Aplicar</a></div>
              </form>
              ...
              <table class="table table-hover m-0">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>—</td>
                    <td><span class="badge text-bg-success">Activo</span></td>
                    <td class="text-end"><a class="btn btn-sm btn-outline-success" href="#materiales-crear">Editar</a> <a class="btn btn-sm btn-outline-danger" href="#">Eliminar</a></td>
                  </tr>
                </tbody>
              </table>
            </div>
              ...
              <table class="table table-hover m-0">
                ...
                <tbody>
                  <tr>
                    <td>—</td>
                    <td>—</td>
                    <td class="text-end"><a class="btn btn-sm btn-outline-success" href="#">Editar</a> <a class="btn btn-sm btn-outline-danger" href="#">Eliminar</a></td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div id="matriz-centro-material" class="card border-success">
            <div class="card-header bg-success-subtle border-success"><span class="fw-semibold text-success">Matriz Centro ⇄ Material</span></div>
            <div class="table-responsive">
              <table class="table table-hover m-0">
                <thead class="table-success">
                  <tr>
        ...
        <section id="mod-contenido" class="mb-5">
              ...
              <table class="table table-hover m-0">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>0</td>
                    <td class="text-end"><a class="btn btn-sm btn-outline-success" href="#publicaciones-crear">Editar</a> <a class="btn btn-sm btn-outline-danger" href="#">Eliminar</a></td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div id="multimedia" class="card border-success mb-3">
            <div class="card-header bg-success-subtle border-success"><span class="fw-semibold text-success">Multimedia</span></div>
            <div class="table-responsive">
              <table class="table table-hover m-0">
                <thead class="table-success">
                  <tr>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>—</td>
                    <td>—</td>
                    <td class="text-end"><a class="btn btn-sm btn-outline-danger" href="#">Eliminar</a></td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div id="comentarios" class="card border-success">
            <div class="card-header bg-success-subtle border-success"><span class="fw-semibold text-success">Comentarios</span></div>
            <div class="table-responsive">
              <table class="table table-hover m-0">
                <thead class="table-success">
                  <tr>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="text-end"><a class="btn btn-sm btn-outline-success" href="#">Aprobar</a> <a class="btn btn-sm btn-outline-warning" href="#">Ocultar</a> <a class="btn btn-sm btn-outline-danger" href="#">Eliminar</a></td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <section id="mod-mensajeria" class="mb-5">
              ...
              <table class="table table-hover m-0">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>—</td>
                    <td>—</td>
                    <td class="text-end"><a class="btn btn-sm btn-outline-success" href="#mensajeria-mensajes">Ver</a></td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div id="mensajeria-mensajes" class="card border-success">
            <div class="card-header bg-success-subtle border-success"><span class="fw-semibold text-success">Mensajes</span></div>
        ...
        <section id="mod-reportes" class="mb-5">
          ...
          <div class="card border-success mb-3">
            <div class="card-header bg-success-subtle border-success"><span class="fw-semibold text-success">Movimientos de inventario</span></div>
        ...
        <section id="mod-sistema" class="mb-5">
          ...
          <div class="row g-3">
            <div class="col-12 col-xl-4">
              <div class="card border-success h-100">
                <div class="card-header bg-success-subtle border-success"><span class="fw-semibold text-success">Jobs</span></div>
                <div class="table-responsive">
                  <table class="table table-hover m-0">
                    <thead class="table-success">
                      <tr>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>—</td>
                        <td>—</td>
                        <td class="text-end"><a class="btn btn-sm btn-outline-success" href="#">Reintentar</a></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
            ...
            <div class="col-12 col-xl-4">
              <div class="card border-success h-100">
                <div class="card-header bg-success-subtle border-success"><span class="fw-semibold text-success">Sesiones activas</span></div>
                <div class="table-responsive">
                  <table class="table table-hover m-0">
                    <thead class="table-success">
                      <tr>
            ...
            <div class="col-12 col-xl-4">
              <div class="card border-success h-100">
                <div class="card-header bg-success-subtle border-success"><span class="fw-semibold text-success">Migrations</span></div>
                <div class="table-responsive">
                  <table class="table table-hover m-0">
                    <thead class="table-success">
                      <tr>
