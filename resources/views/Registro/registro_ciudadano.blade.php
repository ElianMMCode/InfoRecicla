<x-app-layout>
    ...
    <link rel="stylesheet" href="/css/Registro/styleCiudadano.css">
        ...
        <main class="container">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <!-- FORMULARIO -->
                    <form method="POST" action="/registro/ciudadano" id="citizenForm" class="needs-validation"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="numeroDocumento"
                                    name="numeroDocumento" minlength="5" maxlength="20" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex gap-3">
                                    <div class="form-check"><input class="form-check-input" type="radio"
                                            name="genero" id="gM" value="Masculino"><label
                                            class="form-check-label" for="gM">Masculino</label></div>
                                    <div class="form-check"><input class="form-check-input" type="radio"
                                            name="genero" id="gF" value="Femenino"><label
                                            class="form-check-label" for="gF">Femenino</label></div>
                                    <div class="form-check"><input class="form-check-input" type="radio"
                                            name="genero" id="gNB" value="Otro"><label
                                            class="form-check-label" for=id="recibeNotificaciones""gNB">Otro</label>
                                    </div>
                                </div>
                            </div>
